...
PROTODEF(PROTOCOL_REDPINE, CC2500, AETRG, REDPINE_Cmds, "Redpine")
...
PROTODEF(PROTOCOL_V761, NRF24L01, AETRG, V761_Cmds, "V761")
#ifdef _DEVO6_TARGET_H_
PROTODEF(PROTOCOL_UDI, NRF24L01, AETRG, UDI_Cmds, "UDI")
#endif
