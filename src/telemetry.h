...
typedef enum {
    ...
    // SMART RX telemetry
    I2C_SMART_BAT_CELL_1,
    I2C_SMART_BAT_CELL_2,
    I2C_SMART_BAT_CELL_3,
    I2C_SMART_BAT_CELL_4,
    I2C_SMART_BAT_CELL_5,
    I2C_SMART_BAT_CELL_6,
    I2C_SMART_BAT_CELL_7,
    I2C_SMART_BAT_CELL_8,
    I2C_SMART_BAT_CELL_9,
...
typedef enum {
    ...
    TELEM_CRSF_VTX_FREQ,
    TELEM_CRSF_VTX_PITMODE,
    TELEM_CRSF_VTX_POWER,
    TELEM_CRSF_BATT_REMAINING,
    TELEM_CRSF_VERTSPD,
    TELEM_CRSF_ALTITUDE,
    TELEM_CRSF_RX_RSSI_PERC,
    TELEM_CRSF_RX_RF_POWER,
    TELEM_CRSF_TX_FPS,
